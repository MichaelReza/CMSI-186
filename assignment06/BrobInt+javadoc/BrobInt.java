...
public class BrobInt {
   ...
   public BrobInt multiply( BrobInt bint ) {
     if (this.sign == 1 && bint.sign == 0) {
       ...
       if (allZeroDetect(this)) {
         this.internalValue = this.internalValue.substring(0,1);
         this.reversed = this.internalValue;
         this.byteVersion = new byte[1];
         this.byteVersion[0] = this.ZERO.byteVersion[0];
       }
   ...
   *  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ */
   public BrobInt divide( BrobInt bint ) {
     ...
     while (n < d1.length /*|| Integer.parseInt(d3bint.internalValue) == 0*/) {
       ...
       if (Integer.parseInt(d3bint.internalValue) < Integer.parseInt(bint.internalValue) && n < d2.length) {
   ...
   *  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ */
   public static void main( String[] args ) {
      ...
      System.out.println( "\n    Multiplying 53 by 3 add 1 divide 2 divide 2 divide 2: " );
      try { System.out.println( "      expecting: 20\n        and got: " + new BrobInt("53").multiply( new BrobInt("3") ).add(BrobInt.ONE).divide(BrobInt.TWO).divide(BrobInt.TWO).divide(BrobInt.TWO) ); }
      catch( Exception e ) { System.out.println( "        Exception thrown:  " + e.toString() ); }
   }
}
