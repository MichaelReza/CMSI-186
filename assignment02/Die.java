...
public class Die {
   ...
   */
   public int roll() {
     this.pips = (int)( Math.ceil(Math.random() * this.sides) );
     return this.pips;
   }
   ...
   */
   public void setSides( int sides ) {
     if (sides < this.MINIMUM_SIDES) {
       throw new IllegalArgumentException("Please choose at least 4 sides for this die.");
     }
     this.sides = sides;
     this.pips = sides;
   }
