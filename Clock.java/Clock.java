...
public class Clock {
   ...
   */
   public double getHandAngle() {
     if (this.getMinuteHandAngle() < this.getHourHandAngle()) {
   ...
   *  @param args String array of user inputs
   ...
   */
   public static void main( String args[] ) {
      ...
      try { System.out.println( (clock.INVALID_ARGUMENT_VALUE == clock.validateTimeSliceArg( "1800.0" )) ? " - got INVALID_ARGUMENT_VALUE" : " - this should not be a valid timeSlice" ); }
      catch( Exception e ) { System.out.println ( " - Exception thrown: " + e.toString() ); }

      // Testing tick();
      System.out.println( "\n    Testing tick()....");
      System.out.print(   "    using default timeSlice, expecting double value 60.0" );
      try { System.out.println( (60.0 == clock.tick()) ? " - got 60.0" : " - no joy" ); }
      catch( Exception e ) { System.out.println ( " - Exception thrown: " + e.toString() ); }

      // Testing getHourHandAngle();
      System.out.println( "\n    Testing getHourHandAngle()....");
      System.out.print(   "    after ticking above, expecting double value 0.5004" );
      ...
      System.out.println( "\n    Testing getMinuteHandAngle()....");
      System.out.print(   "    after ticking above, expecting double value 6.0" );
      ...
      System.out.println( "\n    Testing getHandAngle()....");
      System.out.print(   "    after ticking above, expecting double value 5.4996" );
      try { System.out.println( ((Math.abs(clock.getMinuteHandAngle() - clock.getHourHandAngle())) == clock.getHandAngle()) ? " - got 5.4996" : " - no joy" ); }
      catch( Exception e ) { System.out.println ( " - Exception thrown: " + e.toString() ); }

      // Testing get getTotalSeconds();
      System.out.println( "\n    Testing getTotalSeconds()....");
      System.out.print(   "    after ticking above, expecting double value 60.0" );
      try { System.out.println( (60.0 == clock.getTotalSeconds()) ? " - got 60.0" : " - no joy" ); }
      catch( Exception e ) { System.out.println ( " - Exception thrown: " + e.toString() ); }

      // Repeating tick() four times
      System.out.println( "\n    Ticking forward four more times...");
      for (int i = 0; i < 4; i++) {
        clock.tick();
      }
      ...
      // Testing getHourHandAngle();
      System.out.println( "\n    Testing getHourHandAngle()....");
      System.out.print(   "    after ticking above, expecting double value 2.502" );
      try { System.out.println( (2.502 == clock.getHourHandAngle()) ? " - got 2.502" : " - no joy" ); }
      catch( Exception e ) { System.out.println ( " - Exception thrown: " + e.toString() ); }

      // Testing getMinuteHandAngle();
      System.out.println( "\n    Testing getMinuteHandAngle()....");
      System.out.print(   "    after ticking above, expecting double value 30.0" );
      try { System.out.println( (30.0 == clock.getMinuteHandAngle()) ? " - got 30.0" : " - no joy" ); }
      catch( Exception e ) { System.out.println ( " - Exception thrown: " + e.toString() ); }

      // Testing getHandAngle();
      System.out.println( "\n    Testing getHandAngle()....");
      System.out.print(   "    after ticking above, expecting double value 27.498" );
      try { System.out.println( (27.498 == clock.getHandAngle()) ? " - got 27.498" : " - no joy" ); }
      catch( Exception e ) { System.out.println ( " - Exception thrown: " + e.toString() ); }

      // Testing get getTotalSeconds();
      System.out.println( "\n    Testing getTotalSeconds()....");
      System.out.print(   "    after ticking above, expecting double value 300.0" );
      try { System.out.println( (300.0 == clock.getTotalSeconds()) ? " - got 300.0" : " - no joy" ); }
      catch( Exception e ) { System.out.println ( " - Exception thrown: " + e.toString() ); }
   }
}
